            ...
            <form action="#" method="POST" className="mt-8">
              <div className="space-y-5">
                ...
                <div>
                  <button
                    type="button"
                    className={`inline-flex w-full items-center justify-center rounded-md bg-black px-3.5 py-2.5 font-semibold leading-7 text-white hover:bg-black/80 ${loading?"bg-gray-50":"bg-black"}`}
                        onClick={submitForm}
                  >
                    {loading?"Creating Account...":"Create Account"} <ArrowRight className="ml-2" size={16} />
                  </button>
                </div>
              </div>
            </form>
